...
int open_serial(char *port_name, HANDLE &h)
{
	...
	// typical valid bps speeds for Arduno Uno and similar Arduinos
...
//	param.BaudRate    = CBR_9600; // default -- slow but stable
	param.BaudRate    = CBR_115200; // fast but stable
//	param.BaudRate    = 250000;
//	param.BaudRate    = 500000; // very fast but still stable for my Uno
//	param.BaudRate    = 1000000; // pushing it but still stable for my Uno

//	param.BaudRate    = 2000000; 
	// fastest stable speed for my Arduino Uno 
	// -- not recommended since there is no factor of safety
